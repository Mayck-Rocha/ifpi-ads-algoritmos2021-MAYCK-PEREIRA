...
function main(){
    ...
    const coordenada_x_1 = Number(prompt('Coordenada x: '))
    const coordenada_y_1 = Number(prompt('Coordenada y: '))

    const coordenada_x_2 = Number(prompt('Coordenada x: '))
    const coordenada_y_2 = Number(prompt('Coordenada y: '))
