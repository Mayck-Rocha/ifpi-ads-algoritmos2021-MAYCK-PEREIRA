...
function main(){
   ...
   const delta = valor_delta(coef_a, coef_b, coef_c)
...
function valor_delta(coef_a, coef_b, coef_c){
    return coef_b **2 - 4 *coef_a * coef_c
}

function raiz_1_calculo(coef_a, coef_b, coef_c){
  return  (- (coef_b) + Math.sqrt(valor_delta(coef_a, coef_b, coef_c))) / 2 * coef_a
}
