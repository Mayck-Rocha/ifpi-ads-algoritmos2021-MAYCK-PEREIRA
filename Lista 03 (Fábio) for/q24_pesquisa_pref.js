...
function main(){
    ...
    const qts_habitantes = Number(prompt('Insira a quantidade de habitantes: '))
    ...
    for(let i = 1; i <= qts_habitantes; i++){
        ...
        let salario = Number(prompt('Insira o salário(R$): '))
        let qts_filhos = Number(prompt('Insira a quantidade de filhos: '))
