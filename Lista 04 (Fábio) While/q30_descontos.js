...
function main() {
    const valor_investido = Number(prompt('Insira o valor que será investido mensalmente: '))
    const taxa_juros = Number(prompt('Insira a taxa de juros que será aplicada mensalmente: '))
